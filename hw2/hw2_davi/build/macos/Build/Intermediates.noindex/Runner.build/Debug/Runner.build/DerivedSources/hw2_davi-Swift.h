...
#ifndef HW2_DAVI_SWIFT_H
#define HW2_DAVI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hw2_davi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8hw2_davi11AppDelegate")
...
SWIFT_CLASS("_TtC8hw2_davi17MainFlutterWindow")
