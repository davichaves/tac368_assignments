// api key b3d1701d9bd347ec9db163200250311
// weatherapi.com
...
class Weather1 extends StatelessWidget {
        ...
        builder: (context, state) {
          return Builder(
            builder: (context) {
              ...
              return Column(
                children: [
                  Row(children: [BB("temp C"), BB("${mc.state.msg}")]),
                  ElevatedButton(
                    onPressed: () async {
  ...
  Future<String> _networkCall(int x) async {
    final url = Uri.parse(
      ...
      '?key=b3d1701d9bd347ec9db163200250311&q=90007&aqi=no',
    );
